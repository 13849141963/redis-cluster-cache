...
public class TestLockRedisClient4 {
    ...
    public void test(){
        ...
        boolean b = RedisLockUtil.tryGetDistributedLock(jedis, "1871", String.valueOf(123415l), 60000);
        System.out.println("是否获取锁:"+b);

        //Jedis jedis, String lockKey, String requestId
        boolean b1 = RedisLockUtil.releaseDistributedLock(jedis, "1871", String.valueOf(123415l));
