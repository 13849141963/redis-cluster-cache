...
public class TestLockRedisClient3 {
    ...
    public void test(){
        ...
        boolean b = RedisLockUtil.tryGetDistributedLock(jedis, "1817", String.valueOf(123451l), 60000);
        System.out.println("是否获取锁:"+b);

        //Jedis jedis, String lockKey, String requestId
        boolean b1 = RedisLockUtil.releaseDistributedLock(jedis, "1817", String.valueOf(123451l));
